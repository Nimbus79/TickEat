...
@WebServlet(name = "ConsultarInformacoesServlet", urlPatterns = "/Informacoes")
public class ConsultarInformacoesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (claims == null) {
            ...
            if (emailConsumidor != null && expir.after(now) && type.equals("Consumidor")) {
                ...
                List<Cantina> cantinas = FacadeBeans.listarCantinasAtivas();
                ...
                if (cantinas == null) {
                    ...
                    mensagem.put("cantinas", Util.parseCantinasAtivasList(cantinas));
                }
            }
            else {
                mensagem.put("success", false);
