...
public class ComentarioDAO {
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comentario) session.load(main.Comentario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comentario) session.get(main.Comentario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.load(main.Comentario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.get(main.Comentario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryComentario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From main.Comentario as Comentario");
		if (condition != null)
	...
	public static Comentario createComentario() {
		return new main.Comentario();
	}
	
	public static boolean save(main.Comentario comentario) throws PersistentException {
		try {
			tickeatPersistentManager.instance().saveObject(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(main.Comentario comentario) throws PersistentException {
		try {
			tickeatPersistentManager.instance().deleteObject(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(main.Comentario comentario) throws PersistentException {
		try {
			tickeatPersistentManager.instance().getSession().refresh(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(main.Comentario comentario) throws PersistentException {
		try {
			tickeatPersistentManager.instance().getSession().evict(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
