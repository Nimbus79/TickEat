...
public class PedidoDAO {
	...
	public static Pedido loadPedidoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Pedido) session.load(main.Pedido.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido getPedidoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Pedido) session.get(main.Pedido.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido loadPedidoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pedido) session.load(main.Pedido.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido getPedidoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pedido) session.get(main.Pedido.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPedido(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From main.Pedido as Pedido");
		if (condition != null)
	...
	public static Pedido createPedido() {
		return new main.Pedido();
	}
	
	public static boolean save(main.Pedido pedido) throws PersistentException {
		try {
			tickeatPersistentManager.instance().saveObject(pedido);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(main.Pedido pedido) throws PersistentException {
		try {
			tickeatPersistentManager.instance().deleteObject(pedido);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(main.Pedido pedido) throws PersistentException {
		try {
			tickeatPersistentManager.instance().getSession().refresh(pedido);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(main.Pedido pedido) throws PersistentException {
		try {
			tickeatPersistentManager.instance().getSession().evict(pedido);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
