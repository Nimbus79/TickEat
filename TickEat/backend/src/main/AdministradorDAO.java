...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, String email) throws PersistentException {
		try {
			return (Administrador) session.load(main.Administrador.class, email);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, String email) throws PersistentException {
		try {
			return (Administrador) session.get(main.Administrador.class, email);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, String email, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(main.Administrador.class, email, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, String email, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(main.Administrador.class, email, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdministrador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From main.Administrador as Administrador");
		if (condition != null)
	...
	public static Administrador createAdministrador() {
		return new main.Administrador();
	}
	
	public static boolean save(main.Administrador administrador) throws PersistentException {
		try {
			tickeatPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(main.Administrador administrador) throws PersistentException {
		try {
			tickeatPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(main.Administrador administrador) throws PersistentException {
		try {
			tickeatPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(main.Administrador administrador) throws PersistentException {
		try {
			tickeatPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
