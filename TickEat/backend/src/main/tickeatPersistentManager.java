...
public class tickeatPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "tickeat";
	...
	private tickeatPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new tickeatPersistentManager();
		}
