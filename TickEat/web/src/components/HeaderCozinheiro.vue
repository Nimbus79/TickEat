    ...
    <v-navigation-drawer app v-model="drawer" absolute temporary>
      ...
      <v-list dense>
        <v-list-item v-for="item in items" :key="item.title" link>
          <v-list-item-icon>
            <span v-if="item.click" v-on:click="logout()" style="color: inherit; text-decoration: none;">
          ...
          <v-list-item-content>
            <a v-if="item.click" v-on:click="logout()" style="color: inherit; text-decoration: none;">
...
export default {
  ...
  data: () => {
    return {
      drawer: null,
      items: [
        { title: "Página Inicial", icon: "fa fa-th-large", ref: "/inicioCoz" },
